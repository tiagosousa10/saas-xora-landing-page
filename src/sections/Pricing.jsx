         ...
         <div className='container'>
            ...
            {plans.map((plan, index) => (
              ...
              >
                     ...
                     <div 
                        className={clsx('absolute left-0 right-0 z-2 flex items-center justify-center', index === 1 ? '-top-6' : '-top-6 xl:-top-11')}
                     >
                        <img 
                           src={plan.logo} 
                           alt={plan.title} 
                     ...
                     <div 
                        className={clsx('relative flex flex-col items-center', index === 1 ? "pt-24" : "pt-12" )}
                     >
                        <div 
                           className={clsx('small-2 rounded-20 relative z-2 mx-auto mb-6 border-2 px-4 py-1.5 uppercase', index === 1 ? 'border-p3 text-p3' : 'border-p1 text-p1')}
                        >
                           {plan.title}
                        </div>
                     ...
                     <div className={clsx('body-1 relative z-2 mb-10 w-full border-b-s2 pb-9 text-center text-p4')}>{plan.caption}</div>
                  </div>
